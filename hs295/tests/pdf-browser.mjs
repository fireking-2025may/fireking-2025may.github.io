...
for(const [key,value] of Object.entries({husbandGivenNames:'Jean-Luc',wifeGivenNames:'Mary-Jane',surname:'Smith-Jones',address1:'1 Sample Road',address2:'Exampleton',country:'United Kingdom',postcode:'AB1 2CD',husbandIdentifierValue:'1234567890'}))await page.fill(`[name=${key}]`,value);
...
await page.selectOption('[name=transferorPersonId]',{label:'Jean-Luc Smith-Jones'});
await page.selectOption('[name=transfereePersonId]',{label:'Mary-Jane Smith-Jones'});
...
console.log(`Generated ${output} for a husband-and-wife pair with hyphenated names and an eight-digit acquisition cost; PDF is flattened and structurally clean.`);
