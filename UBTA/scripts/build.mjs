...
const modules=['src/editor/table-values.js','src/state/schema.js','src/state/history.js','src/state/persistence.js','src/editor/dom-runs.js','src/editor/interactions.js','src/editor/repagination.js','src/editor/printing.js','src/editor/command-routing.js','src/editor/list-rendering.js','src/editor/block-deletion.js','src/editor/insertion-context.js','src/main.js'];
