...
const modules=['src/state/schema.js','src/state/history.js','src/state/persistence.js','src/editor/dom-runs.js','src/editor/interactions.js','src/editor/repagination.js','src/main.js'];
